...
// Per-bar glyphs: each 15×73, extracted straight from the reference PNG.
// Each encapsulates one bar column's dither + solid fill + markers +
// the midline row. Gaps between bars are blank (framebuffer is cleared).
#define GLYPH_MULTIDAY_BAR_W 15
#define GLYPH_MULTIDAY_BAR_H 73
#define GLYPH_MULTIDAY_BAR_STRIDE 2
static const uint8_t GLYPH_MULTIDAY_BAR_0_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
static const uint8_t GLYPH_MULTIDAY_BAR_1_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
static const uint8_t GLYPH_MULTIDAY_BAR_2_ROWS[73][2] = {
    { 0xFF, 0xFE },
    { 0xFF, 0xFE },
    { 0xFE, 0xFE },
    { 0xFC, 0x7E },
...
static const uint8_t GLYPH_MULTIDAY_BAR_3_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
static const uint8_t GLYPH_MULTIDAY_BAR_4_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
static const uint8_t GLYPH_MULTIDAY_BAR_5_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
static const uint8_t GLYPH_MULTIDAY_BAR_6_ROWS[73][2] = {
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
    { 0xAA, 0xAA },
    { 0x55, 0x54 },
...
// Lookup for rendering in permuted order.
static const uint8_t* const GLYPH_MULTIDAY_BARS[7] = {
    &GLYPH_MULTIDAY_BAR_0_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_1_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_2_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_3_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_4_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_5_ROWS[0][0],
    &GLYPH_MULTIDAY_BAR_6_ROWS[0][0],
};

// 3×5 right-pointing triangle marker that flanks the chart on the left,
// matching the reference PNG exactly.
#define GLYPH_MARKER_R_W 3
#define GLYPH_MARKER_R_H 5
#define GLYPH_MARKER_R_STRIDE 1
static const uint8_t GLYPH_MARKER_R_ROWS[5][1] = {
    { 0x80 }, // #..
    { 0xC0 }, // ##.
    { 0xE0 }, // ###
    { 0xC0 }, // ##.
